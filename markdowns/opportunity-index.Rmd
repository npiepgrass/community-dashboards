...
labels_COI <- sprintf(
  "<img src = 'https://github.com/npiepgrsds/community-dashboards/blob/main/markdowns/plots/mapminis/%s.png?raw=true' width = 150><br/><strong>%s</strong><br/>%s, %s County<br/><strong>Child Opportunity: %g/100</strong>",
